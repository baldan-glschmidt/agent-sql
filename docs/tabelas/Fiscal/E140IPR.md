...
Vendas - Notas Fiscais de Saída - Itens de Produto - Reforma tributária
...
| VlrOid | Number(015,2) | Sim | Valor da Operação individual do Declarante |
| VlrToi | Number(015,2) | Sim | Valor da Torna Individual do Declarante |
| VlrRai | Number(015,2) | Sim | Valor do Redutor de Ajuste Individual do Declarante |
| VlrRei | Number(015,2) | Sim | Valor do Redutor Social Individual do Declarante |
