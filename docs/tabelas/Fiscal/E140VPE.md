...
Vendas - Nota Fiscal de Saída - Vale Pedágio
...
| DocIde | String(014) | Sim | Número do CNPJ da empresa fornecedora do vale pedágio |
| NumCom | String(020) | Sim | Número do comprovante de compra do vale pedágio |
| CodCli | Number(009,0) | Sim | Código do cliente da nota fiscal de saída |
