...
Vendas - Pedidos - Ligação de Pedido X Pedidos - Produtos
...
| SeqIpd | Number(004,0) | Não | Sequência de item do pedido normal |
| SeqPxp | Number(004,0) | Não | Sequência de ligações entre o pedido norma e pedidos de previsão |
...
| SeqPdp | Number(004,0) | Não | Sequência de item do pedido de previsão |
