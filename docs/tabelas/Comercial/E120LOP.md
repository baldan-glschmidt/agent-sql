...
| EmpPed | Number(004,0) | Não | Código da empresa |
| FilPed | Number(005,0) | Não | Código da filial |
| AbrPed | String(1000) | Sim | Abrangência de Pedidos |
